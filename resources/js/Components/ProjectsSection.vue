                ...
                >
                    ...
                    <div class="p-6">
                        ...
                        <div class="space-y-3">
                            ...
                            <div v-if="project.url || project.repository" class="flex space-x-3">
                                <a 
                                    v-if="project.url"
                                    :href="project.url" 
                                    target="_blank"
                            ...
                            <button 
                                ...
                                class="w-full bg-gray-100 hover:bg-gray-200 text-gray-700 text-center py-2 px-4 rounded-md text-sm font-medium transition duration-200 border border-gray-300"
                            >
                                <svg class="w-4 h-4 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
